...
" Config {{{
    ...
    " Where the projects are stored at. Will start from this root and search down for all someapp.settings files
    ...
    if !isdirectory(g:django_project)
        echoerr "Could not access ".g:django_project
    endif
" }}}
